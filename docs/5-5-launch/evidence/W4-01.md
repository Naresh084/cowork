...
- Added coverage for resume dedupe and compensation behavior:
  - `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src-sidecar/src/workflow/engine.resume.test.ts`
...
```bash
pnpm --filter @gemini-cowork/sidecar test -- src/workflow/engine.resume.test.ts
