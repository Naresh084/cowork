...
```bash
pnpm --filter @cowork/sidecar test -- src/memory/consolidation-service.test.ts src/memory/semantic-memory-extractor.test.ts src/benchmark/suites/twin-track-core.test.ts
