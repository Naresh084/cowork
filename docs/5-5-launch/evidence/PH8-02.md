...
- `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src-sidecar/src/connectors/secret-service.ts`
- `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src-sidecar/src/connectors/secret-service.test.ts`
- `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src-tauri/src/commands/credentials.rs`
- `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src-tauri/src/sidecar.rs`

## Verification Commands

```bash
pnpm --filter @gemini-cowork/sidecar exec vitest run --config vitest.config.ts src/connectors/secret-service.test.ts
