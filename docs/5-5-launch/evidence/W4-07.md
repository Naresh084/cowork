...
- Added workflow pack invocation API in workflow tool layer:
  ...
  - file: `/Users/naresh/Work/Personal/cowork/apps/desktop/src-sidecar/src/tools/workflow-tool.ts`
...
- Added tool tests validating pack execution path and typed error behavior:
  - `/Users/naresh/Work/Personal/cowork/apps/desktop/src-sidecar/src/tools/workflow-tool.test.ts`

## Files Changed

- /Users/naresh/Work/Personal/cowork/apps/desktop/src-sidecar/src/tools/workflow-tool.ts
- /Users/naresh/Work/Personal/cowork/apps/desktop/src-sidecar/src/tools/workflow-tool.test.ts

## Verification Commands

```bash
pnpm --filter @cowork/sidecar test -- src/tools/workflow-tool.test.ts
