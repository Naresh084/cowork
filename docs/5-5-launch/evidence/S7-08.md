...
- `/Users/naresh/Work/Personal/cowork/apps/desktop/src-sidecar/src/security/audit-log.ts`
- `/Users/naresh/Work/Personal/cowork/apps/desktop/src-sidecar/src/security/audit-log.test.ts`
- `/Users/naresh/Work/Personal/cowork/apps/desktop/src-sidecar/src/ipc-handler.ts`

## Verification Commands

```bash
pnpm --filter @cowork/sidecar exec vitest run --config vitest.config.ts src/security/audit-log.test.ts src/ipc-handler.idempotency.test.ts src/external-cli/run-manager.test.ts
