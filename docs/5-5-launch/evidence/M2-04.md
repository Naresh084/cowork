...
pnpm --filter @gemini-cowork/sidecar test -- src/memory/memory-orchestrator.test.ts src/memory/consolidation-service.test.ts src/memory/semantic-memory-extractor.test.ts
