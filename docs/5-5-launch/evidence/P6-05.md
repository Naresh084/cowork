...
- Extended tool-policy shared contracts in:
  - `/Users/naresh/Work/Personal/geminicowork/packages/shared/src/types/tool-policy.ts`
- Added:
...
- Updated sidecar policy engine profile coverage and reason-code emission:
  - `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src-sidecar/src/tool-policy.ts`
- Updated policy modal profile options:
  - `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src/components/modals/ToolPolicyModal.tsx`
- Added reason-code unit tests:
  - `/Users/naresh/Work/Personal/geminicowork/apps/desktop/src-sidecar/src/tool-policy.explainability.test.ts`
...
pnpm --filter @gemini-cowork/sidecar test -- src/tool-policy.explainability.test.ts
```
