      ...
      return (
        <div className="space-y-4">
          ...
          <SectionCard
            ...
            description="Stitch API key and specialized Google tool models are now in the Specialized Models tab."
          >
            <p className="text-xs text-white/55">
              Open <span className="text-white/75">Settings → Specialized Models</span> to manage Stitch, Computer Use,
              and Deep Research model configuration.
            </p>
          </SectionCard>
        </div>
      );
