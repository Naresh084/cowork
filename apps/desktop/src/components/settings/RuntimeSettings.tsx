    ...
    <div className="space-y-4" data-tour-id="settings-runtime-section">
      <div>
        ...
        <p className="mt-1 text-xs text-white/40">
          Configure sandboxing, runtime token limits, Stitch tooling, and Google specialized model IDs.
        </p>
      </div>
      ...
      <div className="flex items-start gap-3 rounded-xl border border-[#1D4ED8]/20 bg-[#1D4ED8]/10 p-4">
        ...
        <p className="text-xs text-[#93C5FD]">
          Runtime changes apply to future tool calls. If you changed provider, base URL, or chat
          model separately, start a new session for full runtime consistency.
        </p>
      </div>
    </div>
  );
