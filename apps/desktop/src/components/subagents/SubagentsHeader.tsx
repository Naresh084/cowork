...
import { useSubagentStore, type SubagentCategory } from '../../stores/subagent-store';

const CATEGORIES: Array<{ value: SubagentCategory | 'all'; label: string }> = [
  { value: 'all', label: 'All' },
...
export function SubagentsHeader({ onCreateClick }: SubagentsHeaderProps) {
  const {
    searchQuery,
    setSearchQuery,
    selectedCategory,
