                ...
                <div className="w-32">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="app-select app-select--compact w-full bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-100 focus:ring-2 focus:ring-blue-500 text-center text-xl"
                    >
                      {EMOJI_OPTIONS.map((e) => (
